...
class ProductRequirementMapperTest {
    ...
    public void fillProductRequirement() throws Exception {
        ...
        System.out.println(processRequirements);
    ...
    private void fillSubModelProcessRequirement(List<SubModelElement> subModelElements) {
        subModelElements.forEach(subModelElementsInProcessRequirement -> {
            ...
            System.out.println("Idshort of Requirements " + idShortOfProcessRequirement);
            ...
            subModelElementsInElement.forEach(subModelElementDeep1 -> {
                ...
                System.out.println("Alle Submodels" + subModelElementDeep1);
                if (property != null) {
